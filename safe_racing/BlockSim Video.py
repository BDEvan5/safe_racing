...
anim = FuncAnimation(fig, update, frames = 200, interval = 15) 

# FFwriter = FFMpegWriter()
    
anim.save('BlockSim.webp', fps = 20) 
# anim.save('BlockSim.mp4', fps = 20, extra_args=['-vcodec', 'libx264']) 
# anim.save('BlockSim.mp4', writer = 'ffmpeg', fps = 20) 
    # anim.save('BlockSim.gif', writer = 'ffmpeg', fps = 10) 
